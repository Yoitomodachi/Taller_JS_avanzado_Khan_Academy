...
var Ball = function(position, speed) {
    ...
    this.update = function() {
        //Colisión de paletas con la pelota.
...
var drawPlayers = function() {
    //Restrincción del escenario para los jugadores.
...
draw = function() {
    ...
    if(keyIsPressed){       // Evaluar si se esta presionando una tecla.
        
        // Sí se presiona la tecla hacía arriba.
        if (keyCode === UP){
            
            movePlayerUp();
        }
        // Sí se presiona la tecla hacía abajo.
